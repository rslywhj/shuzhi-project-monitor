...
当前版本已完成高保真界面、D1/R2 持久化、身份权限、项目和用户管理、Excel批量导入、12节点模板治理、自定义节点候选提升、规则版本、风险措施闭环、周报附件、站内及外部通知、催报升级、组合分析、跨周期事后度量、报表导出、核心工作流 API 及审计能力。后续将继续扩展延期概率预测、资源冲突分析和更完整的业务分支回归。
