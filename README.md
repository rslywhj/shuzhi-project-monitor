...
当前版本已完成高保真界面、D1/R2 持久化、身份权限、项目和用户管理、Excel批量导入、12节点模板治理、自定义节点候选提升、规则版本、风险措施闭环、周报附件、站内通知与催报升级、组合分析与报表导出、核心工作流 API 及审计能力。后续将继续补充外部消息渠道、更多跨周期洞察以及覆盖完整业务分支的自动化测试。
