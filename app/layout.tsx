...
const themeBootstrapScript = `(function(){try{var p=localStorage.getItem("shuzhi-color-scheme-v1");var t=p==="light"||p==="dark"?p:(matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light");var s=Number(localStorage.getItem("shuzhi-font-scale-v1"));s=Number.isFinite(s)?Math.min(2,Math.max(1,Math.round(s*10)/10)):1.1;document.documentElement.dataset.theme=t;document.documentElement.style.colorScheme=t;document.documentElement.style.setProperty("--ui-font-scale",String(s))}catch(e){}})();`;
